...
def CLI():
    ...
    parser.add_argument("--lang", type=str, help="the language that model should detect accurately, example english: 'en'", default="en")
    ...
    #parser.add_argument("-h", "--help", help="show the syntax, arguments of MirrorMyManga CLI", action="help")
    args = parser.parse_args()
    #if args.help:
    #    print("usage: app.py input_path output_path lang dpi [-h | --help] [-S | --showlogs] [-V | --verbose]\n\noptions:\n-h, --help     show this help message and exit\n-V, --verbose    show low level details like image size, width lenght, boundarries etc...\n-S, --showlogs            show logs of occuring processes\n\npositional arguments:\n  input_path               source file(PDF or CBZ) of the transformed manga/comic\n  output_path               destination file(PDF or CBZ) of the transformed manga/comic\n  lang            the language that model should detect accurately, example english: 'en'\n  dpi            the DPI to use for scanning PDF pages\n")
